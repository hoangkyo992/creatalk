namespace Cms.Application.Shared.Resources;
...
public partial struct ErrorMessages
{
    ...
    public const string ATTENDEE_NOT_FOUND = nameof(ATTENDEE_NOT_FOUND);
    public const string ATTENDEE_CANCELLED = nameof(ATTENDEE_CANCELLED);
    public const string ATTENDEE_NOT_CANCELLED = nameof(ATTENDEE_NOT_CANCELLED);
}